...
def parse_args():
    ...
    parser.add_argument("--learning_rate", type=float, default=os.environ.get("SM_HP_LEARNING_RATE", 0.1))
...
def train():
    ...
    shutil.copy(os.path.join(code_dir, "train_pytorch.py"), inference_code_path)
...
if __name__ == "__main__":
    ...
    print("Setting up the training environment variables ...")
    
    from env.environment import Environment, write_env_vars
